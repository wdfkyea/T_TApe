...
public:
    ...
    ulong localPlayer = 0x01ee8d50 + 0x8; //0x1388eb8 //.?AVC_GameMovement@@=0x01ee8d50
 
    ulong entityList = 0x1b37b18; //cl_entitylist=0x1b37b18
    ...
    ulong weaponPunch = 0x22d8; //m_currentFrameLocalPlayer.m_vecPunchWeapon_Angle=0x24b0
    ...
    ulong projectileSpeed = 0x2b98; //CWeaponX!m_flProjectileSpeed=0x1f18
    ulong projectileScale = 0x1f20; //CWeaponX!m_flProjectileScale=0x1f20 missing after newest update?
    ulong ammoInClip = 0x1648;
